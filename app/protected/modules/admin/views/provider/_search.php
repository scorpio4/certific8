...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'cert_website'); ?>
		<?php echo $form->textField($model,'cert_website',array('size'=>60,'maxlength'=>255)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'cert_email'); ?>
		<?php echo $form->textField($model,'cert_email',array('size'=>60,'maxlength'=>255)); ?>
	</div>
