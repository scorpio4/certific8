...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('certified_by')); ?>:</b>
	<?php echo CHtml::encode($data->certified_by); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('skill_discipline_id')); ?>:</b>
	<?php echo CHtml::encode($data->skill_discipline_id); ?>
	<br />
