...
$this->menu = array(
    ...
    array('label' => 'Create ProviderTrainer', 'url' => array('create'),'linkOptions'=>array('class'=>'btn btn-green btn-sm')),
);
...
?>
<div class="panel">
    <div class="panel-heading panel-head">Provider Trainers</div>
    <div class="panel-body">
        <section class="panel panel-default">
            <?php
            $this->widget('zii.widgets.grid.CGridView', array(
                'id' => 'provider-trainer-grid',
                ...
                'columns' => array(
                    ...
                    array(
                        'name' => 'provider_id',
                        'value' => '$data->provider->org->legal_name',
                    ),
                    'valid_until',
                    array(
                        'class' => 'CButtonColumn',
