...
--
-- Dumping data for table `c8_email_template`
--

INSERT INTO `c8_email_template` (`id`, `type`, `subject`, `template`) VALUES
(4, 'email_verify', ' Confirm your email address to start using Certific8', 'To start using your Certific8 account, click \r\n\r\nthe link to confirm your email address.<br><br>\n{Confirm_Email_URL}<br><br>\nCertific8 Team<br>');
...
(112, '', 'asdas', '', 'Team Leader', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', 'avatar.png', NULL, 1, 0, 1, 1, 0, 105, NULL, NULL);
...
(310, 112, 37, 'job1', NULL, 0, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', '2014-01-04', '2014-01-07');
...
CREATE TABLE IF NOT EXISTS `c8_profile_skill` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `profile_id` int(11) NOT NULL DEFAULT '0',
  `user_skill_id` int(11) NOT NULL DEFAULT '0',
  `order` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `c8_profile_skill_ibfk_1` (`profile_id`),
  KEY `c8_profile_skill_ibfk_2` (`user_skill_id`)
...
INSERT INTO `c8_profile_skill` (`id`, `profile_id`, `user_skill_id`, `order`) VALUES
(7, 112, 28, 1),
(8, 112, 29, 3),
(9, 112, 30, 2),
(10, 112, 31, 4);
...
(1, 'sdfsdf', 'sdfsdf', 'http://localhost/certific8/uploads/social/small_logo/fb.jpg', 'fsdfsdfsdf', 'usernamesdfsdfsdf', 'sdfsdfsdf', 'sdfsdfsdf'),
(2, 'LinkedIn', 'https://www.linkedin.com', 'http://localhost/certific8/uploads/social/small_logo/lin.jpg', '', 'username', '', '');
...
--
-- Dumping data for table `c8_social_profile`
--

INSERT INTO `c8_social_profile` (`id`, `social_id`, `user_id`, `username`, `profile_id`, `identifier`, `order`) VALUES
(1, 1, 105, 'ttttttt', 112, '', 0),
(2, 2, 105, 'linkd', 112, '', 0);
...
INSERT INTO `c8_user` (`id`, `first_name`, `last_name`, `full_name`, `email`, `mobile`, `webpage`, `house_unit_number`, `street`, `suburb`, `state`, `postcode`, `country`, `username`, `password_sha256`, `registration_token`, `avatar`, `is_registered`, `is_paid`, `is_test`, `membership_id`, `profile_id`, `current_salary`, `geo_territory`, `ipv4address`, `first_joined`, `last_seen`, `last_valdiated`) VALUES
(1, '', '', '', 'AasaSAAasaSasASA', '', '', '', '', '', '', '', '', 'admin', '$2a$13$N/GirTqOZ6NIkT7SXZosaef//gTFvSwz2kN4Pb0Sh0WFOFWW.WmrW', '', 'Koala.jpg', 0, 0, 1, 3, NULL, 0, '', '', '0000-00-00', '0000-00-00', '0000-00-00'),
...
(5, 'Marilou', 'Wintheiser', 'Lonzo Reichel', 'myles.kohlesr@gmail.com', '2222222', 'http://tgsasdassss.in', '9905', 'Jacey Rapid', '58517 Saige Overpass', 'Iowa', '15799', 'Guernsey', 'eichmann.luz', '3b0fa125df7b74874c1940cf55245857cc09288a03be316eda12eb2da9ff800c', '37af6c30f754bee7b8c39fa0344ee6c10159d79f', 'avatar.png', 0, 0, 1, 9, NULL, 0, 'Tanzania', '150.60.183.125', '1970-03-20', '2003-02-17', '1976-12-24'),
...
(11, 'Allene', 'Pagac', 'Casimir Trantow', 'cathryn38@gmail.com', '5555555sss', 'http://yy.insss', '5068', 'Casper Skyway', '404 Nova Fords', 'Utah', '98141-0657', 'Costa Rica', 'erdman.eriberto', 'fa75c25b4fabecd6df49b878eede89aaf4d111929009ef6ef950339d0ccedb82', 'bb317b8c3916b114e61e342e0c1608b6e3124d6b', 'avatar.png', 0, 0, 1, 9, NULL, 0, 'Palau', '140.58.94.48', '1982-11-27', '1980-12-04', '1975-12-19'),
...
(104, '', '', '', '', '', '', '', '', '', '', '', '', '', '$2a$13$zRPFfMMLg2K./0H2ol6NcuAzQgASjz40.R0mGud085Mu1a0TNzSja', '', '', 1, 0, 1, 1, NULL, 0, '', '', '0000-00-00', '0000-00-00', '0000-00-00'),
(105, 'toj', 'j', 'toj', 'toj@yahoo.in', '22222222222', 'http://www.www.w', '', '', '', '', '', '', '', '$2a$13$X6w8OUem43wThdxBtC3cqOsvfQlDPrHwr.4sJRnvRHNQ1MsSqDUMq', 'XIRCuHTle9', 'avatar_105.jpg', 1, 0, 1, 1, NULL, 0, '', '2130706433', '0000-00-00', '2014-10-23', '2014-10-13'),
(106, '', '', 'ray', 'rayan@gmail.com', '', '', '', '', '', '', '', '', '', '$2a$13$hJCve.sk7n/Wgl11a9ikCOgo.wKGifiiQAFV93eGBmtPNOd5L7bLG', 'uwTRG7m4Fm', 'avatar.png', 0, 0, 1, 1, NULL, 0, '', '2130706433', '0000-00-00', '0000-00-00', '2014-10-13');
...
(27, 105, 14, 1, '55', 555, '2014-10-08', '2014-10-04'),
(28, 105, 14, 16, '66rrttt', 66, '2014-01-01', '2014-03-10'),
(29, 105, 19, 16, '4', 3, '1970-01-01', '1970-01-01'),
(30, 105, 5, 18, '343', 343, '1970-01-01', '2014-01-10'),
(31, 105, 17, 4, '33', 44, '1970-01-01', '2014-03-10'),
(32, 105, 5, 4, '33', 33, '1970-01-01', '2014-08-10'),
(33, 105, 3, 4, '33', 44, '2014-08-10', '2014-02-10'),
(34, 105, 5, 4, '22', 33, '1970-01-01', '1970-01-01'),
(35, 105, 9, 4, '33', 22, '2014-01-01', '2014-10-08'),
(36, 105, 10, 2, '444', 55, '2014-10-01', '2014-10-02');
...
ALTER TABLE `c8_profile_skill`
  ...
  ADD CONSTRAINT `c8_profile_skill_ibfk_2` FOREIGN KEY (`user_skill_id`) REFERENCES `c8_user_skill` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
